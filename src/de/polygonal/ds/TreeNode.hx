...
class TreeNode implements Collection
{
    ...
    public var numChildrens(get, never) : Int;
    public var numSiblings(get, never) : Int;
    ...
    /**
		 ...
		 */
    public function new(obj : Dynamic = null, parent : TreeNode = null)
    {
        data = obj;
    ...
    /**
		 ...
		 */
    private function get_numChildrens() : Int
    {
    ...
    /**
		 ...
		 */
    private function get_numSiblings() : Int
    {
        if (parent != null)
        {
